...
> [!NOTE]
> OpenAI compatibility is experimental and is subject to major adjustments including breaking changes. For fully-featured access to the Ollama API, see the Ollama [Python library](https://github.com/nikolaydimitrov/ollama-python), [JavaScript library](https://github.com/nikolaydimitrov/ollama-js) and [REST API](https://github.com/nikolaydimitrov/ollama/blob/main/docs/api.md).
